...
Famously, the 1D Ising model has no phase transition when varying a magnetic field in the parallel direction. Here we will show how that is analytically derived, and develop some mathematical techniques along the way. Hello,
